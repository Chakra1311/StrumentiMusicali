...
Route::delete('/instrument/delete/{instrument}', [InstrumentController::class, 'destroy'])->name('instrument.destroy');

Route::get('/instrument/byUser/{user}', [InstrumentController::class, 'showByUser'])->name('instrument.byUser');
